...
class PopulerTvWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<TvBloc, TvStates>(
        buildWhen: (previous, current)=> previous.PopulerTvRequest != current.PopulerTvRequest,
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                          ...
                          child: GestureDetector(
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context) =>DetielsTvScreen(id: state.PopulerTvMovies[index].id),
                            ...
                            child: ClipRRect(
                                ...
                                child: CachImageWidght(url: ConstantApi().getImageUrl(
                                  state.PopulerTvMovies[index].backdropPath!,),
